...
import './REGOCertificatesBarChart.css';

const REGOCertificatesBarChart = () => {
    ...
    return (
      <div>
        {contextHolder}
        <div className='REGOCertificatesBarChart_Header'>
          <div className='REGOCertificatesBarChart_Title'>
            <span className='REGOCertificatesBarChart_TitleHighlight'>REGO Certificates</span>{graphDataUnit}
          </div>
          <div className='REGOCertificatesBarChart_Options'>
            <Select
        ...
        <div className='REGOCertificatesBarChart_Box'>
            {contextHolder}
            <Column {...config} />
        </div>
      </div>
...
export default REGOCertificatesBarChart;
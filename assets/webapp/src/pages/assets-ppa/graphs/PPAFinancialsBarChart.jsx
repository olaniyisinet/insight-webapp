...
import './PPAFinancialsBarChart.css'

const PPAFinancialsBarChart = () => {
    ...
    const asyncFetch = (graphOption) => {
      axios.post(getRequestUrl("/graph-by-name"), {
        ...
        "graphName": "generator-ppa-financials",
    ...
    const exportData = () => {
      ...
      link.download = 'ppafinancials.csv';
      link.href = url;
      link.click();
    }
    ...
    return (
      <div>
        {contextHolder}
        <div className='PPAFinancialsBarChart_Header'>
          <div className='PPAFinancialsBarChart_Title'>
            <span className='PPAFinancialsBarChart_TitleHighlight'>PPA Financials</span>{graphDataUnit}
          </div>
          <div className='PPAFinancialsBarChart_Options'>
        ...
        <div className='PPAFinancialsBarChart_Box'>
            {contextHolder}
            <Column {...config} />
        </div>
      </div>
...
export default PPAFinancialsBarChart;
...
import './PPAREGOCertificatesBarChart.css';

const PPAREGOCertificatesBarChart = () => {
    ...
    const asyncFetch = (graphOption) => {
      axios.post(getRequestUrl("/graph-by-name"), {
        ...
        "graphName": "generator-ppa-rego-certificates",
    ...
    const exportData = () => {
      ...
      link.download = 'pparegocertificates.csv';
      link.href = url;
      link.click();
    }
    ...
    return (
      <div>
        {contextHolder}
        <div className='PPAREGOCertificatesBarChart_Header'>
          <div className='PPAREGOCertificatesBarChart_Title'>
            <span className='PPAREGOCertificatesBarChart_TitleHighlight'>PPA REGO Certificates</span>{graphDataUnit}
          </div>
          <div className='PPAREGOCertificatesBarChart_Options'>
        ...
        <div className='PPAREGOCertificatesBarChart_Box'>
            {contextHolder}
            <Column {...config} />
        </div>
      </div>
...
export default PPAREGOCertificatesBarChart;
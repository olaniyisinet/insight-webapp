...
import './AssetREGOCertificatesBarChart.css';

const AssetREGOCertificatesBarChart = () => {
    ...
    const exportData = () => {
      ...
      link.download = 'assetsregocertificates.csv';
      link.href = url;
      link.click();
    }
    ...
    return (
      <div>
        {contextHolder}
        <div className='AssetREGOCertificatesBarChart_Header'>
          <div className='AssetREGOCertificatesBarChart_Title'>
            <span className='AssetREGOCertificatesBarChart_TitleHighlight'>Assets REGO Certificates</span>{graphDataUnit}
          </div>
          <div className='AssetREGOCertificatesBarChart_Options'>
        ...
        <div className='AssetREGOCertificatesBarChart_Box'>
            {contextHolder}
            <Column {...config} />
        </div>
      </div>
...
export default AssetREGOCertificatesBarChart;